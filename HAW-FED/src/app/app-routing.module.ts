...
const routes: Routes = [
  ...
  { path: '', redirectTo: '/introduccion/1', pathMatch: 'full' },
  {
    ...
    children: [
      ...
      { path: 'wikiiot/leccion1/contenido/1',component: VistaComponenteComponent},
      { path: 'wikiiot/leccion1/contenido/2', component: VistaComponenteComponent},
      //{ path: 'wikiiot/leccion1/contenido/3'},
